...
class RelModelStanford(RelModel):
    ...
    def __init__(self, classes, rel_classes, mode='sgdet', num_gpus=1, require_overlap_det=True,
        ...
        super(RelModelStanford, self).__init__(classes, rel_classes, mode=mode, num_gpus=num_gpus,
                                               ...
                                               pooling_dim=4096, use_bias=False)
        ...
        self.obj_unary = nn.Linear(1024, SIZE)
        self.edge_unary = nn.Linear(1024, SIZE)
    ...
    def forward(self, x, im_sizes, image_offset,
        ...
        if self.training:
            ...
            rois, labels, result.rel_labels = proposal_assignments_gtbox(rois.data, gt_boxes.data, gt_classes.data,
